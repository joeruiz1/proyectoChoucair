...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target INPUT_COURSE = Target.the("Encontrar el curso ").located(By.id("coursesearchbox"));
    ...
    public static final Target NAME_COURSE = Target.the("extraer nombre del curso").located(By.xpath("//h1[contains(text()),'Recursos Automatizacion Bancolombia']"));
